"""track irregularity forecasting file for ensuring the package is executable
as `track-irregularity-forecasting` and `python -m track_irregularity_forecasting`
"""
import importlib
